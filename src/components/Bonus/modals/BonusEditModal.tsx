...
import {BonusEditRequest, BonusRegisterResponse} from "../../../interfaces/bonus.interface";
// Redux
import {handleSnackbar} from "../../../store/slices/snackbarSlice";
import {BonusEditModalProps} from "./BonusEditModal.props";
...
const BonusEditModal = ({open, bonus, onClose, onSuccessClose, ...restProps}: BonusEditModalProps): JSX.Element => {
    ...
    const handleFormSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
        try {
            ...
            setLoading(true);
            const apiData: BonusEditRequest = {
                id: bonus.id,
                name: title,
    ...
    useEffect(() => {
        if (open) {
            setTitle(bonus.name);
            setDailyLimit(`${bonus.daily_limit}`);
            setMonthlyLimit(`${bonus.month_limit}`);
            setPayWithBonusSkip(bonus.pay_with_bonus_skip);
